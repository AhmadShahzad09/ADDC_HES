...
@Slf4j
@Service("OnDemandReadLoadProfileCapturePeriod_V09")
public class OnDemandReadLoadProfileCapturePeriod extends AbstractOnDemand {
//    @Override
//    protected void processOnDemandCommand(String id, String command, OnDemandOrder orders, String ipPort) {
//        new Thread(new Runnable() {
//            @Override
//            public void run() {
//                executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.READ_LOAD_PROFILE_CAPTURE_PERIOD, ipPort);
//            }
//        }).start();
//    }
...
//        commandVO.setGWip("");
//        commandVO.setGWsn("");
//        commandVO.setProfiles(new ArrayList<>());
//        return commandVO;
//    }
