...
@Slf4j
@Service("OnDemandGetPaymentMode_V13")
public class OnDemandGetPaymentMode extends AbstractOnDemand {
...
//            @Override
//            public void run() {
//                executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.GET_PAYMENT_MODE, ipPort);
//            }
//        }).start();
//    }
//
...
//    }
	...
	protected String getCoapPath() {
		return AppConstants.OnDemand.COAP_PATH.GET_PAYMENT_MODE;
	}
