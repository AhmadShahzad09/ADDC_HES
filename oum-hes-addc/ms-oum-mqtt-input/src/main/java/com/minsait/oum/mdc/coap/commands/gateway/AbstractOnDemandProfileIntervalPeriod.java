...
public abstract class AbstractOnDemandProfileIntervalPeriod extends AbstractOnDemand {
    protected enum ProfileIntervalPeriod {
        ...
        public static Optional<AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod> from(final String profileKey) {
            return Arrays.stream(AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod.values())
                    .filter(profile -> profile.getProfileKey().equals(profileKey)).findFirst();
        }

        public static Optional<AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod> fromName(final String profileName) {
            return Arrays.stream(AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod.values())
    ...
    protected ProfileIntervalPeriod resolveIntervalProfile(OnDemandOrder order) {
        ...
        Optional<AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod> profileOpt = AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod.from(profileKey);

        if (!profileOpt.isPresent()) {
            Optional<AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod> profileNameOpt = AbstractOnDemandProfileIntervalPeriod.ProfileIntervalPeriod.fromName(profileKey);
