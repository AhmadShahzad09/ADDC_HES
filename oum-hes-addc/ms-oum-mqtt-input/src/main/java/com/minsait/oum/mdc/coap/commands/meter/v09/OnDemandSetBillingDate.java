...
@Slf4j
@Service("OnDemandSetBillingDate_V09")
...
//			@Override
//			public void run() {
//				executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.SET_BILLING_DATE, ipPort);
//			}
//		}).start();
//	}
//
