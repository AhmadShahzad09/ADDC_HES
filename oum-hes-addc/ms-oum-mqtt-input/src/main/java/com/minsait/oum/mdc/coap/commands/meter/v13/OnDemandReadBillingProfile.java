...
@Slf4j
@Service("OnDemandReadBillingProfile_V13")
public class OnDemandReadBillingProfile extends AbstractOnDemand {
...
//            @Override
//            public void run() {
//                executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.READ_BILLING_PROFILE, ipPort);
//            }
//        }).start();
//    }
//
...
//    }
	...
	protected String getCoapPath() {
		return AppConstants.OnDemand.COAP_PATH.READ_BILLING_PROFILE;
	}
