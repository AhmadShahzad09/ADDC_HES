...
@Service
@Slf4j
public class EtisalatMessageService {

	private final EtisalatMessageStream messageStreams;
	...
	public EtisalatMessageService(final EtisalatMessageStream messageStreams) {
