...
@Slf4j
@Service("OnDemandSwitchStatus_V13")
public class OnDemandSwitchStatus extends AbstractOnDemand {
...
//			@Override
//			public void run() {
//				executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.SWITCH_STATUS, ipPort);
//			}
//		}).start();
//	}
//
...
//	}
	...
	protected String getCoapPath() {
		return AppConstants.OnDemand.COAP_PATH.SWITCH_STATUS;
	}
