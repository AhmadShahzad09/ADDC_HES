...
public class OnInstallationNotificationCallback implements INotificationCallback {
	...
	public void onData(String senderInfo, List<Object> values) {
		log.info("onInstallation");
		log.debug("onInstallation: senderInfo: " + senderInfo);
		...
		onAlarmRequest.setResponseType(ResponseType.PUSH_ON_INSTALLATION);
		...
		// create call and update OnInstallation notification
