...
@Slf4j
@Service("OnDemandReadPowerQualityProfile_V13")
public class OnDemandReadPowerQualityProfile extends AbstractOnDemand {
...
//            @Override
//            public void run() {
//                executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.LOAD_PROFILE_POWER_QUALITY, ipPort);
//            }
//        }).start();
//    }
//
...
//    }
	...
	protected String getCoapPath() {
		return AppConstants.OnDemand.COAP_PATH.POWER_QUALITY_PROFILE;
	}
