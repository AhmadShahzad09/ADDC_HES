...
@Slf4j
@Service("OnDemandReadLoadProfile2_V13")
public class OnDemandReadLoadProfile2 extends AbstractOnDemand {
...
//            @Override
//            public void run() {
//                executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.LOAD_PROFILE_TWO, ipPort);
//            }
//        }).start();
//    }
//
...
//    }
	...
	protected String getCoapPath() {
		return AppConstants.OnDemand.COAP_PATH.LOAD_PROFILE_2;
	}
