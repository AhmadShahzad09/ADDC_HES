...
@Slf4j
@Service("OnDemandGetLoadLimitThreshold_V13")
public class OnDemandGetLoadLimitThreshold extends AbstractOnDemand {
...
//			@Override
//			public void run() {
//				executeCommand(buildCommand(id,orders), AppConstants.OnDemand.COAP_PATH.GET_LOAD_LIMIT_THRESHOLD, ipPort);
//			}
//		}).start();
//	}
//
...
//	}
	...
	protected String getCoapPath() {
		return AppConstants.OnDemand.COAP_PATH.GET_LOAD_LIMIT_THRESHOLD;
	}
