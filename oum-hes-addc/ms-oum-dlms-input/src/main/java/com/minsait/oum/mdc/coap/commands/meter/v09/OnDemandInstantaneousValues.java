...
@Slf4j
@Service("OnDemandInstantaneousValues_V09")
public class OnDemandInstantaneousValues extends AbstractOnDemand {
...
//            @Override
//            public void run() {
//                executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.INSTANTANEOUS_LOAD_PROFILE, ipPort);
//            }
//        }).start();
//    }
//
