...
@Slf4j
@Service("OnDemandGetDemandIntegrationPeriod_V09")
public class OnDemandGetDemandIntegrationPeriod extends AbstractOnDemand {
...
//            @Override
//            public void run() {
//                executeCommand(buildCommand(id, orders), AppConstants.OnDemand.COAP_PATH.GET_DEMAND_INTEGRATION_PERIOD, ipPort);
//            }
//        }).start();
//    }
//
...
//    }
	...
	protected String getCoapPath() {
		return AppConstants.OnDemand.COAP_PATH.GET_DEMAND_INTEGRATION_PERIOD;
	}
