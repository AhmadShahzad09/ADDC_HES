...
public abstract class AbstractMessageHandlerProcessor extends AbstractMessageProcessor {
	...
	protected void processTelemetryCallToTaskListener(Request request, MdmNotifier mdmNotifier) {
	...
	@FunctionalInterface
	public static interface MdmNotifier extends DeviceProcessor {

		public static MdmNotifier empty = (request, call, device) -> {};
